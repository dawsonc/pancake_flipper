...
void DoMain() {
  ...
  std::string pancake_csv_filename = "results/arm_viz2_trace_umax40_ceiling5_mu0.0_T60.npz_pancake_to.csv";
  ...
  std::string flipper_csv_filename = "results/arm_viz2_trace_umax40_ceiling5_mu0.0_T60.npz_flipper_to.csv";
